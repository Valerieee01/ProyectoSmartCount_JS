...
import { cargar_tabla, forceReloadAllClientes } from "./mostrarTabla.js";
...
export const initCrearClienteForm = async () => {
    ...
    const selectPersonaExistente = document.querySelector('#id_persona_existente');
    ...
    const enviar = async (e) => {
        e.preventDefault();
       const data = {
        id_cliente: selectPersonaExistente.value
       }
